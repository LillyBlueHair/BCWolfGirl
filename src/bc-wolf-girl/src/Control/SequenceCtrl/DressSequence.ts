...
import { ChatRoomAction, CheckOutfitItem, CheckOutfitItemCE } from "bc-utilities";
...
import { CheckItem, OutfitItemsMap, ToolsCrate, ToolsInjector, ToolsVisor } from "../OutfitCtrl";
