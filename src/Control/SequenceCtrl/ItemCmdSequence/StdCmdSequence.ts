...
export function StdResultBranch(player: Character, data: CmdData, on_missing: CmdMissingCallback, on_success: CmdSuccessCallback) {
...
export function StdCmdSequence(player: Character, type: ControllerType, mode: CtrlType, messages: CmdSequenceMessage) {
