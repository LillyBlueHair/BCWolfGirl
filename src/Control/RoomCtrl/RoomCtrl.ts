...
export function RoomLeaveSequence(player: Character, cmd_src: { sender: number | Character, type: CommandType }) {
...
export function RoomForceLeaveSequence(player: Character, cmd_src: { sender: number | Character, type: CommandType }) {
...
export function RoomComeHereSequence(player: Character, cmd_src: { sender: number | Character, type: CommandType, room: { name: string, space: string } | undefined }) {
